...
QT_MOC_LITERAL(8, 79, 22), // "updateMyTreeWidgetSlot"
QT_MOC_LITERAL(9, 102, 9), // "itemClick"
QT_MOC_LITERAL(10, 112, 6), // "viewIt"
QT_MOC_LITERAL(11, 119, 8), // "deleteIt"
QT_MOC_LITERAL(12, 128, 14) // "sltShowPopMenu"

    },
    "MyTreeWidget\0updateTreeGLSignal\0\0mode\0"
    "CGeoMap*\0map\0updateLayerIDSignal\0"
    "layerID\0updateMyTreeWidgetSlot\0itemClick\0"
    "viewIt\0deleteIt\0sltShowPopMenu"
};
...
void MyTreeWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->updateMyTreeWidgetSlot((*reinterpret_cast< CGeoMap*(*)>(_a[1]))); break;
        case 3: _t->itemClick(); break;
        case 4: _t->viewIt(); break;
        case 5: _t->deleteIt(); break;
        case 6: _t->sltShowPopMenu((*reinterpret_cast< const QPoint(*)>(_a[1]))); break;
        default: ;
        }
